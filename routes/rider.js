...
const { getOTP, registerData, login, toggleDuty, auth, newOrder, changeStatus, getHotelData, getOrderData, getCustomerData, getCompleteOrderData, completeOrder, profileInfo, profileEdit} = require("../controllers/rider");
